...
public class CadastroUsuario implements Logic {
	...
	public String executa(HttpServletRequest req, HttpServletResponse res)
		...
		.comCelular(req.getParameter("telcelular"))
		.comEmail(req.getParameter("email"))
		.comRg(req.getParameter("rg"))
		.comTel(req.getParameter("telfixo"))
		.comTipo(TipoPessoa.fromInteger(Integer.parseInt(req.getParameter("rdTipoPessoa"))))
		.builder();	
